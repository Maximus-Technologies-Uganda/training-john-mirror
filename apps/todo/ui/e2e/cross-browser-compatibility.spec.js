...
test.describe('Cross-Browser Compatibility', () => {
  ...
  test('should handle JavaScript disabled gracefully', async ({ page, browserName, context }) => {
    ...
    test.skip(process.env.CI || browserName === 'webkit', 'JavaScript disable test not supported in this environment')
    ...
    console.log(`⏭️ JavaScript disabled test skipped for ${browserName}`)
  })
})
