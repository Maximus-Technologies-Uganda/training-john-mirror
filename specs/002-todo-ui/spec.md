...
- What happens when a user rapidly clicks add/remove buttons multiple times?
...
- **Task**: Represents a to-do item with text description, due date, and completion status
